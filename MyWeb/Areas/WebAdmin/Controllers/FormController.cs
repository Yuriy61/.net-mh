...
namespace MyWeb.Areas.WebAdmin.Controllers
{
    public class FormController : BasicController
    {
        ...
        public ActionResult List(int pageSize = 20, int pageIndex = 1)
        {
            ...
            List<AMW.Model.Entity.MldForm> list = dal.QueryList(pageIndex, pageSize, "id", "id desc", "1=1");
            Dictionary<string, object> dic = new Dictionary<string, object>();
            ViewBag.Pager = new AMW.Model.Pager() { PageSize = pageSize, PageCount = pageCount, PageIndex = pageIndex, SubmitLink = "/WebAdmin/Form/List", List = dic };
            return View(list);
        }
        #endregion
