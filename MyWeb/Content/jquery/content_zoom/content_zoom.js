jQuery.fn.fancyZoom = function(options){
  ...
  if ($('#zoom').length == 0) {
      var html = '<div class="round_shade_box" id="zoom" style="z-index: 99999;"> \
...
jQuery.fn.fancyZoom1 = function (options) {
    ...
    function show(e) {
        ...
        var width = (zoom_width || 800) + 40;
        var height = (zoom_height || 800) + 40;
        var d = window_size;
        ...
        if (options.scaleImg) {
            zoom_content.html("<img src='"+$(this).attr("zoomImg")+"' />");
            $('#zoom_content img').css('width', '100%');
        } else {
            zoom_content.html('');
        }
